...
- ffxiv_mac.mypatch : Add support for using Marzent's XIVLauncher fork for Mac login - https://github.com/marzent/FFXIVQuickLauncher
...
- 0001-Allow-RtlSizeHeap-to-check-pointers-from-GlobalLock-.mypatch : HeapSize/RtlHeapSize can operate on GMEM_MOVEABLE GlobalAlloc/LocalAlloc locked pointers. Resolve crashing issues with wxWidgets drag and drop. Fix Wrye Bash, DO NOT breaks Dotnet40 installation.  This is another fix for - https://bugs.winehq.org/show_bug.cgi?id=38924
